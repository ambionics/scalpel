...
from _internal_mitmproxy import optmanager

CONF_DIR = "~/._internal_mitmproxy"
CONF_BASENAME = "_internal_mitmproxy"
LISTEN_PORT = 8080
...
class Options(optmanager.OptManager):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.add_option(
            ...
            "Location of the default _internal_mitmproxy configuration files."
        )
        self.add_option(
            "certs", Sequence[str], [],
            """
        ...
        self.add_option(
            ...
            "Set supported ciphers for client <-> _internal_mitmproxy connections using OpenSSL syntax."
        )
        self.add_option(
            "ciphers_server", Optional[str], None,
            "Set supported ciphers for _internal_mitmproxy <-> server connections using OpenSSL syntax."
        )
        self.add_option(
