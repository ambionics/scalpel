...
class RedirectLocal(Redirect):
    ...
    def handle(self, packet):
        ...
        if pid not in self.trusted_pids:
            ...
            # but this was identified as necessary in https://github.com/_internal_mitmproxy/_internal_mitmproxy/pull/3174.
...
class TransparentProxy:
    """
    Transparent Windows Proxy for _internal_mitmproxy based on WinDivert/PyDivert. This module can be used to
    ...
    which _internal_mitmproxy sees, but this would remove the correct client info from _internal_mitmproxy.
    """
...
if __name__ == "__main__":
    ...
    @click.option("-p", "--proxy-port", type=int, metavar="8080", default=8080,
                  help="The port _internal_mitmproxy is listening on.")
    def redirect(**options):
        """Redirect flows to _internal_mitmproxy."""
