...
from _internal_mitmproxy import hooks
...
class Log:
    """
        The central logger, exposed to scripts as _internal_mitmproxy.ctx.log.
    """
...
class AddLogHook(hooks.Hook):
    """
    Called whenever a new log entry is created through the _internal_mitmproxy
